...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(21),
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(46),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(41),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rel_expression, 1),
  [51] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rel_expression, 1),
  [55] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rel_expression_repeat1, 2), SHIFT_REPEAT(11),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_rel_expression_repeat1, 2),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rel_expression_repeat1, 2), SHIFT_REPEAT(11),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rel_expression_repeat1, 2),
  [67] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [69] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rel_expression_repeat1, 2), SHIFT_REPEAT(13),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rel_expression_repeat1, 2), SHIFT_REPEAT(13),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_perm_expression_repeat1, 2),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_perm_expression_repeat1, 2), SHIFT_REPEAT(14),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_perm_expression_repeat1, 2),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_perm_expression_repeat1, 2), SHIFT_REPEAT(14),
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_perm_expression_repeat1, 2), SHIFT_REPEAT(15),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_perm_expression_repeat1, 2), SHIFT_REPEAT(15),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_perm_expression, 1),
  [95] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_perm_expression, 1),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 4),
  ...
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 5),
  [135] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [137] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, .production_id = 1),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, .production_id = 1),
  [143] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(29),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_permission, 3, .production_id = 2),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_permission, 3, .production_id = 2),
