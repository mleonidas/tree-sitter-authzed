...
enum {
  ...
  aux_sym_perm_expression_repeat1 = 24,
  aux_sym_rel_expression_repeat1 = 25,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 14:
      ...
      if (lookahead == '-') ADVANCE(5);
      if (sym_identifier_character_set_3(lookahead)) ADVANCE(21);
      END_STATE();
    case 15:
    ...
    case 20:
      ...
      if (sym_identifier_character_set_3(lookahead)) ADVANCE(20);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(24);
      END_STATE();
    case 21:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(26),
  ...
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(28),
  ...
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(24),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4),
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 5),
  [146] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, .production_id = 1),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, .production_id = 1),
